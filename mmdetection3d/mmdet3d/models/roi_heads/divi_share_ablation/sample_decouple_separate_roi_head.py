...
class SampleDecoupleSeparateRoiHead(Base3DRoIHead):
    ...
    def __init__(self,
        ...
        super(SampleDecoupleSeparateRoiHead, self).__init__(
            bbox_head=bbox_head,
    ...
    def init_bbox_head(self, bbox_roi_extractor: dict,
        ...
        assert len(bbox_roi_extractor) == self.num_branch

        for roi_extractor in bbox_roi_extractor:
    ...
    def _bbox_forward(self, keypoint_features: torch.Tensor,
        ...
        """
        pooled_keypoint_features_list = []
        for branch in range(self.num_branch):
            pooled_keypoint_features_list.append(self.bbox_roi_extractor[branch](
                keypoint_features, keypoints[..., 1:], keypoints[..., 0].int(),
                rois))

        bbox_score_list, bbox_reg_list = self.bbox_head(pooled_keypoint_features_list)
