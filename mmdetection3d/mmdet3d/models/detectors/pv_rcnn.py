...
class PointVoxelRCNN(TwoStage3DDetector):
    ...
    def predict(self, batch_inputs_dict: dict, batch_data_samples: SampleList,
        ...
        # add original points to points_feats_dict
        points_feats_dict["points"] = batch_inputs_dict["points"]
        ...
        # <<< save vis data <<<
        # data_gt = {
        #     "bbox" : results_list[0].eval_ann_info["gt_bboxes_3d"].tensor.cpu().numpy() ,
        #     "label" : results_list[0].eval_ann_info["gt_labels_3d"],
        # }

        # data_pred = {
        #     "bbox" : results_list[0].pred_instances_3d.bboxes_3d.tensor.cpu().numpy(),
        #     "label" : results_list[0].pred_instances_3d["labels_3d"].cpu().numpy(),
        #     "score" : results_list[0].pred_instances_3d["scores_3d"].cpu().numpy()
        # }

        # pcd = batch_inputs_dict["points"][0].cpu().numpy()
        ...
        # import pickle
        # with open('data_for_vis/mmrefine-3.pkl', 'wb') as f:
