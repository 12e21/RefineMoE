...
from mmdet3d.evaluation import eval_tp_errors_pts
...
class KittiRelationMetric(BaseMetric):
    ...
    def __init__(self,
        ...
        super(KittiRelationMetric, self).__init__(
            ...
            for i, annos in enumerate(data_annos):
                if len(annos['instances']) == 0:
                    ...
                    for instance in annos['instances']:
                        ...
                        kitti_annos['num_lidar_pts'].append(instance['num_lidar_pts'])
    ...
    def kitti_evaluate(self,
        ...
        for name in results_dict:
            ...
            ap_result_str, ap_dict_ = eval_tp_errors_pts(
                gt_annos, results_dict[name], classes, output_csv_path="./tp_erros_pts.csv")
